...
namespace Records
{
    class Program
    {
        ...
        private static void RecordSample()
        {
            ...
            Console.WriteLine($"{nameof(movie)} == {nameof(newMovie)} returns {movie == newMovie}");
            Console.WriteLine($"{nameof(movie)}.Equals({nameof(newMovie)}) returns {Equals(movie,newMovie)}");
            Console.WriteLine($"{nameof(movie)}.ReferenceEquals({nameof(newMovie)}) returns {ReferenceEquals(movie,newMovie)}");
            Console.WriteLine("--------------------------------------");
            Console.WriteLine();
        }
